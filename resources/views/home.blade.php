        ...
        <div class="row justify-content-center">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-categories-box">
                    <img src="{{ asset('assets/img/categories/img1.jpg') }}" alt="image">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-products-box">
                    ...
                    <div class="products-content">
                        <h3><a href="products-type-4.html">Tbmpoy Men's Tapered</a></h3>
                        <div class="price">
                            <span class="old-price">$321</span>
                            <span class="new-price">$250</span>
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-products-box">
                    ...
                    <div class="products-content">
                        <h3><a href="products-type-4.html">Sunnyme Women's Ponchos</a></h3>
                        <div class="price">
                            <span class="old-price">$210</span>
                            <span class="new-price">$200</span>
                        </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-products-box">
                    ...
                    <div class="products-content">
                        <h3><a href="products-type-4.html">Open Front Knit Sweaters</a></h3>
                        <div class="price">
                            <span class="old-price">$210</span>
                            <span class="new-price">$200</span>
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-products-box">
                    ...
                    <div class="products-content">
                        <h3><a href="products-type-4.html">Block Striped Draped</a></h3>
                        <div class="price">
                            <span class="new-price">$150</span>
                        </div>
                        <div class="star-rating">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-products-box">
                    ...
                    <div class="products-content">
                        <h3><a href="products-type-4.html">Fleece Hooded Sweatshirt</a></h3>
                        <div class="price">
                            <span class="new-price">$240</span>
                        </div>
                        <div class="star-rating">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-products-box">
                    ...
                    <div class="products-content">
                        <h3><a href="products-type-4.html">Sleeve Faux Suede Loose</a></h3>
                        <div class="price">
                            <span class="old-price">$321</span>
                            <span class="new-price">$250</span>
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-products-box">
                    ...
                    <div class="products-content">
                        <h3><a href="products-type-4.html">T-Shirt Casual Stripe Tunic</a></h3>
                        <div class="price">
                            <span class="old-price">$210</span>
                            <span class="new-price">$200</span>
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-products-box">
                    ...
                    <div class="products-content">
                        <h3><a href="products-type-4.html">Chest Cutout Tunics Long</a></h3>
                        <div class="price">
                            <span class="old-price">$210</span>
                            <span class="new-price">$200</span>
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-products-box">
                    ...
                    <div class="products-content">
                        <h3><a href="products-type-4.html">Twist Knotted Tops</a></h3>
                        <div class="price">
                            <span class="new-price">$150</span>
                        </div>
                        <div class="star-rating">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-products-box">
                    ...
                    <div class="products-content">
                        <h3><a href="products-type-4.html">Premium Lightweight Fleece</a></h3>
                        <div class="price">
                            <span class="new-price">$240</span>
                        </div>
                        <div class="star-rating">
