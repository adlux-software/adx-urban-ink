            ...
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="about-content">
                        ...
                        <h2>Welcome to Urban Ink!</h2>

                        <p style="color: #000000">At Urban Ink, we believe that your clothing should tell a story—your story. That's why we’re dedicated to creating t-shirts that are more than just fabric and ink. Our designs are inspired by the future, pushing the boundaries of fashion with innovative and striking visuals.</p>
                        <p style="color: #000000">But we don't stop there. We understand that everyone has a unique tale to tell, which is why we offer custom-order prints to bring your personal vision to life. With Urban Ink, you don’t just wear a t-shirt; you wear your story.</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="about-text">
                            <h3>Our Story</h3>
                            <p>Urban Ink was born out of a shared passion for creativity and self-expression. We are a small team of young, energetic individuals dedicated to crafting unique designs that resonate with the vibrant spirit of today’s youth. What started as a dream to merge art with fashion has now evolved into a brand where every t-shirt tells a story—your story. We’re here to push the boundaries of style and offer something truly different, something that moves with you.</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="about-text">
                            <h3>Our Values</h3>
                            <p>At Urban Ink, we believe in the power of individuality and the importance of self-expression. We value creativity, innovation, and the courage to be different. Our designs are more than just fashion; they’re a statement. We’re committed to quality, ensuring that every piece we produce is crafted with care and attention to detail. We also value sustainability and strive to make choices that respect both people and the planet.
                            </p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6   ">
                        <div class="about-text">
                            <h3>Our Promise</h3>
                            <p>Our Promise
                                Urban Ink promises to deliver more than just clothing. We promise to create pieces that reflect your unique identity, allowing you to wear your story with pride. We’re dedicated to offering cutting-edge designs and personalised prints that make you feel confident and inspired. Above all, we promise to listen to our customers, continually innovate, and stay true to the values that define us.</p>
